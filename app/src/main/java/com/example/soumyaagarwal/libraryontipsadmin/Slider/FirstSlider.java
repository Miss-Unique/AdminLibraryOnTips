...
import com.example.soumyaagarwal.libraryontipsadmin.log_in;
...
public class FirstSlider extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pref = getApplicationContext().getSharedPreferences(prefname, mode);
        editor = pref.edit();

        if (!pref.getBoolean("check",true)) {
            Intent intent = new Intent(FirstSlider.this, log_in.class);
